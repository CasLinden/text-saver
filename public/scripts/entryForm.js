...
function renderEntryForm(
  targetElement, { entryContent = "", entryTitle = "", errors = [] } = {}, httpMethod = "POST") {
  ...
  form.innerHTML = `
        ...
        <textarea class="entry-textarea" name="entry" cols="20" rows="10"></textarea>
